...
import com.lh.shangou.dada.domain.merchant.ShopAddModel;
import com.lh.shangou.dada.domain.order.OrderAddModel;
import com.lh.shangou.dada.service.CityCodeService;
import com.lh.shangou.dada.service.merchant.ShopAddService;
import com.lh.shangou.dada.service.order.OrderAddService;
...
public class example {
    ...
    private static DadaApiResponse addOrder() {// 增加订单
        // 1.初始化配置(isOnline表示是否测试环境)
        AppConfig appConfig = new AppConfig(true);// 正式
        ...
        // 3.初始化service ，并且把请求参数已经设置给orderService对象了
