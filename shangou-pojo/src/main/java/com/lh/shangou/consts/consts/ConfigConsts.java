package com.lh.shangou.consts.consts;
...
public class ConfigConsts {
    ...
    public final static String headerImg = "headerImg";// 首页顶部图片
    public final static String bannerImg = "bannerImg";// 首页banner背景图
    public final static String indexImgs = "indexImgs";// 首页轮播图
    ...
    public final static String userMenus = "userMenus";// 用户页面的轮播图
